...
setup(
    name='svox2',
    version=__version__,
    author='Alex Yu / Modified by Katja Schwarz',
    author_email='alexyu99126@gmail.com / katja.schwarz@uni-tuebingen.de',
    description='PyTorch sparse voxel volume extension, including custom CUDA kernels, adapted some operations to VoxGRAF',
    long_description='PyTorch sparse voxel volume extension, including custom CUDA kernels, adapted some operations to VoxGRAF',
