...
Tensor volume_render_w_alpha_depth_cuvol(SparseGridSpec &, RaysSpec &, RenderOptions &, Tensor, Tensor, Tensor, Tensor, bool);
...
void volume_render_w_alpha_depth_cuvol_backward(SparseGridSpec &, RaysSpec &, RenderOptions &,
                                  Tensor, Tensor, Tensor, Tensor, Tensor, Tensor, Tensor, Tensor, Tensor, GridOutputGrads &);
Tensor volume_render_reg_cuvol(SparseGridSpec &, RaysSpec &, RenderOptions &, float, Tensor);
void volume_render_reg_cuvol_backward(SparseGridSpec &, RaysSpec &, RenderOptions &, float, float, Tensor, Tensor, Tensor, GridOutputGrads &);
...
#define _REG_FUNC(funname) m.def(#funname, &funname)
  ...
  _REG_FUNC(volume_render_reg_cuvol);
  _REG_FUNC(volume_render_reg_cuvol_backward);
  ...
  _REG_FUNC(volume_render_w_alpha_depth_cuvol);
  _REG_FUNC(volume_render_w_alpha_depth_cuvol_backward);
  // _REG_FUNC(volume_render_cuvol_image);
